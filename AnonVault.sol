...
contract AnonVault is Context, IERC20, Ownable {
    ...
    /* Naming */
    string private _name = "AnonVault (ANONVAULT.COM)";
    string private _symbol = "ANONVAULT";
 ...
 /**
    ...
    address public _pancakeswapV2LiquidityPair;     // The address of the PancakeSwap V2 liquidity pairing for VAULT/WBNB
    /**
    ...
    /**
     * @notice Withdraws non-contract (vault) tokens that are stuck as to not interfere with the liquidity
     */
